...
class Task_Data {
    ...
    public:
        ...
        std::chrono::high_resolution_clock::time_point beat(const std::string &cookie);
        void beat(const std::chrono::high_resolution_clock::time_point &c, const std::string &cookie);
